...
impl Dc {
    ...
    pub fn end_path(&self) {
        unsafe {
            _ = Gdi::EndPath(self.hdc);
        }
    }

    pub fn close_figure(&self) {
        unsafe {
            _ = Gdi::CloseFigure(self.hdc);
        }
    }
    ...
    pub fn move_to(&self, x: i32, y: i32) {
        unsafe {
            _ = Gdi::MoveToEx(self.hdc, x, y, None);
        }
    }
    ...
    pub fn polyline(&self, points: &[POINT]) {
        unsafe {
            _ = Gdi::Polyline(self.hdc, points);
        }
    }
    ...
    pub fn polyline_to(&self, points: &[POINT]) {
        unsafe {
            _ = Gdi::PolylineTo(self.hdc, points);
        }
    }
    ...
    pub fn poly_bezier(&self, points: &[POINT]) {
        unsafe {
            _ = Gdi::PolyBezier(self.hdc, points);
        }
    }
    ...
    pub fn poly_bezier_to(&self, points: &[POINT]) {
        unsafe {
            _ = Gdi::PolyBezierTo(self.hdc, points);
        }
    }
    ...
    pub fn arc(&self, x1: i32, y1: i32, x2: i32, y2: i32, x3: i32, y3: i32, x4: i32, y4: i32) {
        unsafe {
            _ = Gdi::Arc(self.hdc, x1, y1, x2, y2, x3, y3, x4, y4);
        }
    }
    ...
    pub fn arc_to(
        ...
        unsafe {
            _ = Gdi::ArcTo(self.hdc, left, top, right, bottom, xr1, yr1, xr2, yr2);
        }
    }
    ...
    pub fn rectangle(&self, left: i32, top: i32, right: i32, bottom: i32) {
        unsafe {
            _ = Gdi::Rectangle(self.hdc, left, top, right, bottom);
        }
    }
    ...
    pub fn round_rect(
        ...
        unsafe {
            _ = Gdi::RoundRect(self.hdc, left, top, right, bottom, width, height);
        }
    }
    ...
    pub fn ellipse(&self, left: i32, top: i32, right: i32, bottom: i32) {
        unsafe {
            _ = Gdi::Ellipse(self.hdc, left, top, right, bottom);
        }
    }

    pub fn stroke_path(&self) {
        unsafe {
            _ = Gdi::StrokePath(self.hdc);
        }
    }

    pub fn fill_path(&self) {
        unsafe {
            _ = Gdi::FillPath(self.hdc);
        }
    }
    ...
    pub fn select_object(&self, h: isize) {
        unsafe {
            Gdi::SelectObject(self.hdc, HGDIOBJ(h as _));
        }
    }
    ...
    pub fn text_out_w(&self, x: i32, y: i32, chars: &[u16]) {
        unsafe {
            _ = Gdi::TextOutW(self.hdc, x, y, chars);
        }
    }

    pub fn text_out_a(&self, x: i32, y: i32, chars: &[u8]) {
        unsafe {
            _ = Gdi::TextOutA(self.hdc, x, y, chars);
        }
    }
